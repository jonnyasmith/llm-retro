<script lang="ts">
	...
	import { NOW, THEME_STAMP } from './data';
	...
	import { Button, Row, Spacer, Text } from '$lib/ui';
	import Chart from './Chart.svelte';
	import FindingCard from '$lib/components/prototypes/FindingCard.svelte';
	...
	import ProvenanceStamp from '$lib/components/prototypes/ProvenanceStamp.svelte';
	import ThemeCard from '$lib/components/prototypes/ThemeCard.svelte';
...
<div class="digest">
	...
	{/if}
	<ProvenanceStamp provenance={THEME_STAMP} now={NOW} />
</div>
