...
- How to verify a change, and the commands that gate it → docs/agents/verification.md
- What belongs in a code comment, and where everything else goes → docs/agents/code-comments.md
